<template>
    <div id="app">
        <el-row :gutter="20" class="search">
            <el-col span="4">
                <el-input placeholder="请输入货物捆包号" prefix-icon="el-icon-search" v-model="input">
                </el-input>
            </el-col>
            <el-col span="6">
        ...
        <el-row>
            <el-col>
                <el-table :data="tableData" border height="850px" style="width: 100%" :row-class-name="tableRowClassName">
                    <el-table-column prop="cargoId" label="货物捆包号" width="100">
                    </el-table-column>
                    <el-table-column prop="cargoName" label="货物名" width="180">
                    </el-table-column>
                    <el-table-column prop="weight" label="货物重量" width="180">
                    </el-table-column>
                    <el-table-column prop="status" label="货物状态" width="180">
                    </el-table-column>
                    <el-table-column prop="ordersId" label="订单编号" width="200">
                    </el-table-column>
                            ...
                            <el-dialog title="录入信息" :visible.sync="editdialogVisible">
                                <span>
                                    <el-form ref="form" :model="editform">
                                        <el-form-item label="货物捆包号" :label-width="formLabelWidth">
                                            <el-input :disabled="true" v-model="editform.cargoId"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="货物名" :label-width="formLabelWidth">
                                            <el-input v-model="editform.cargoName" autocomplete="off"></el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="订单编号" :label-width="formLabelWidth">
                                            <el-input v-model="editform.ordersId" autocomplete="off"></el-input>
                                        </el-form-item>
                            ...
                            <el-dialog title="添加信息" :visible.sync="adddialogVisible">
                                <span>
                                    <el-form ref="form" :model="addform">
                                        ...
                                        <el-form-item label="货物名" :label-width="formLabelWidth">
                                            <el-input v-model="addform.cargoName" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="货物重量" :label-width="formLabelWidth">
                                        ...
                                        <el-form-item label="订单编号" :label-width="formLabelWidth">
                                            <el-input v-model="addform.ordersId" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="备注" :label-width="formLabelWidth">
...
export default {
    ...
    methods: {
        ...
        //从数据库获取数据
        getdata() {
            axios.get('http://localhost:8080/cargo/getByPage',
            {
        ...
        handledelete(index, row) {
            console.log(index, row);
            axios.get('http://localhost:8080/cargo/delete', {
                params: { cargoId: row.cargoId }
            }
            ).then(res => {
                console.log(res.data);
                this.getdata();
        ...
        //添加按钮的方法
        handleadd() {
            axios.get('http://localhost:8080/cargo/add', {
                params: {
        ...
        //查询按钮的方法
        query() {
            axios.get('http://localhost:8080/cargo/getById', {
                //传递参数
                params: {
                    cargoName: this.input
                }
            }).then(res => {
        ...
        //编辑按钮的方法
        edit() {
            axios.post('http://localhost:8080/cargo/update', this.editform)
                .then(response => {
