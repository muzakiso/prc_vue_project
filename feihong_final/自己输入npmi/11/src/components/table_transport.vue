<template>
    <div id="app">
        <el-row :gutter="20" class="search">
            <el-col span="4">
                <el-input placeholder="请输入运单编号" prefix-icon="el-icon-search" v-model="input">
                </el-input>
            </el-col>
            <el-col span="6">
        ...
        <el-row>
            <el-col>
                <el-table :data="tableData" border height="850px" style="width: 100%"
                    :row-class-name="tableRowClassName">
                    <el-table-column prop="transportId" label="运单编号" width="100">
                    </el-table-column>
                    <el-table-column prop="cargoId" label="货物捆绑号" width="120">
                    </el-table-column>
                    ...
                    <el-table-column prop="sendAddress" label="发货地址" width="180">
                    </el-table-column>
                    <el-table-column prop="receiveAddress" label="收货地址" width="180">
                    </el-table-column>
                    <el-table-column prop="amount" label="运费" width="180">
                    </el-table-column>
                    <el-table-column prop="date" label="开票日期" width="250">
                    </el-table-column>
                            ...
                            <el-dialog title="录入信息" :visible.sync="editdialogVisible">
                                <span>
                                    <el-form ref="form" :model="editform">
                                        ...
                                        <el-form-item label="货物捆绑号" :label-width="formLabelWidth">
                                            <el-input v-model="editform.cargoId" autocomplete="off"></el-input>
                                        </el-form-item>
                                        ...
                                        <el-form-item label="发货地址" :label-width="formLabelWidth">
                                            <el-input v-model="editform.sendAddress" type="tel"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="收货地址" :label-width="formLabelWidth">
                                            <el-input v-model="editform.receiveAddress" type="tel"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                            ...
                            <el-dialog title="添加信息" :visible.sync="adddialogVisible">
                                <span>
                                    <el-form ref="form" :model="addform">
                                        ...
                                        <el-form-item label="货物捆绑号" :label-width="formLabelWidth">
                                            <el-input v-model="addform.cargoId" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="车牌号码" :label-width="formLabelWidth">
                                        ...
                                        <el-form-item label="司机电话" :label-width="formLabelWidth">
                                            <el-input v-model="addform.driverTel" type="tel"
                                                autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="发货地址" :label-width="formLabelWidth">
                                            <el-input v-model="addform.sendAddress" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="收货地址" :label-width="formLabelWidth">
                                            <el-input v-model="addform.receiveAddress" autocomplete="off"></el-input>
                                        </el-form-item>
                                        <el-form-item label="运费" :label-width="formLabelWidth">
        ...
        <el-row :gutter="20" class="pagination">
            <el-col span="4" :offset="15">
                <div class="block">
                    <el-pagination background="true" hide-on-single-page="true" @size-change="handleSizeChange"
...
export default {
    ...
    methods: {
        ...
        //从数据库获取数据
        getdata() {
            axios.get('http://localhost:8080/transport/getByPage',
                {
        ...
        handledelete(index, row) {
            console.log(index, row);
            axios.get('http://localhost:8080/transport/delete', {
                params: { id: row.id }
            }
            ).then(res => {
                console.log(res.data);
        ...
        //添加按钮的方法
        handleadd() {
            axios.get('http://localhost:8080/transport/add', {
                params: {
                    transportId: this.addform.transportId,
                    cargoId: this.addform.cargoId,
                    licensePlate: this.addform.licensePlate,
                    driverName: this.addform.driverName,
                    driverTel: this.addform.driverTel,
                    sendAddress: this.addform.sendAddress,
                    receiveAddress: this.addform.receiveAddress,
                    amount: this.addform.amount,
                    date: this.addform.data,
        ...
        //查询按钮的方法
        query() {
            axios.get('http://localhost:8080/transport/getById', {
                //传递参数
                params: {
                    transportId: this.input
                }
            }).then(res => {
        ...
        //编辑按钮的方法
        edit() {
            axios.post('http://localhost:8080/transport/update', this.editform)
                .then(response => {
